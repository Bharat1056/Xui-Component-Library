...
```bash tab="pnpm"
pnpm dlx shadcn@latest add https://xui/r/utils.json
```
...
```jsx
import Card05 from "@/components/xui/card-05";
 ...
 */
import AICardGeneration from "@/components/xui/AICardGeneration";
