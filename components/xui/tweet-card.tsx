...
export default function TweetCard({
  authorName = "Xui",
  authorHandle = "bharatpanigrahi",
  authorImage = "https://res.cloudinary.com/dml2v8bov/image/upload/fl_preserve_transparency/v1759662224/Gemini_Generated_Image_oee98oee98oee98o_bswipu.jpg?_s=public-apps",
  content = [
